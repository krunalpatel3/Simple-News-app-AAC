...
public class Utility {
    ...
    private static final String TAB4 = Utility.class.getSimpleName();
    ...
    private static ArrayList<News> extractResultFromJson(String newsJSON) {
        ...
        try {
            ...
            Log.e("Utility", "Problem parsing the news JSON results", e);
        }
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        try {
            ...
            Log.e(TAB4, "Error closing input stream", e);
        }

        // Extract relevant fields from the JSON response and create an {@link Event} object
        List<News> news = extractResultFromJson(jsonResponse);
        Log.i(TAB4,String.valueOf(news.size()));
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e(TAB4, "Error with creating URL ", e);
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e(TAB4, "Error response code: " + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
            Log.e(TAB4, "Problem retrieving the news JSON results.", e);
        } finally {
